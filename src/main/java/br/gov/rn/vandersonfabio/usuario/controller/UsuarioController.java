package br.gov.rn.vandersonfabio.usuario.controller;
...
import br.gov.rn.vandersonfabio.repository.UsuarioRepository;
...
public class UsuarioController implements Serializable {
	...
	public String GetUsuarioLogado() {
		...
		userLogado = GetUsuarioSession().getUsuario();
